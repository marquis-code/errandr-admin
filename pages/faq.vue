...
useHead({ title: 'Runbooks - Errander Ops' })
...
const faqs = [
  ...
  { q: 'How do I launch Errander on a new campus?', a: 'Contact the Engineering team to configure the new campus in the backend. Then, go to Settings → Campuses → Add Campus. Provide the campus name, location coordinates, and supported delivery zones. Finally, begin onboarding local vendors and recruiting riders.' },
