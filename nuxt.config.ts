  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: "description",
          content: 'Manage Errandr operations, users, and campus vendors.'
        },
        {
          name: "keywords",
          content: 'Errandr admin, campus delivery, order management, food delivery admin'
        },
        { name: "author", content: "Errandr" },

        // ✅ Open Graph (for social previews)
        { property: "og:title", content: "Errandr — Admin Portal" },
        {
          property: "og:description",
          content:
            "Manage Errandr operations, users, and campus vendors securely from the admin portal.",
        },
        ...
        { name: "twitter:title", content: "Errandr — Admin Portal" },
        {
