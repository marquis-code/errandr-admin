<template>
  <div class="space-y-2">
    ...
    <div v-else-if="displayPhone && !isPhoneValid" class="flex items-center gap-1 text-parentPrimary text-sm">
...
import { ChevronDown, Search, Check, AlertCircle, AlertTriangle, CheckCircle } from 'lucide-vue-next'
