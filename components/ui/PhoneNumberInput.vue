<template>
  <div class="mb-2 relative">
              ...
              <div class="p-4 border-b-[0.5px] border-gray-100 bg-gray-50">
                <div class="relative">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Search"
                    class="w-full pl-10 pr-3 py-2.5 bg-white border-[0.5px] border-gray-100 rounded-lg focus:border-[#3BAB22] focus:ring-1 focus:ring-[#3BAB22] outline-none text-base placeholder-gray-400"
                    @click.stop
                  />
                </div>
              </div>
    ...
    <p v-if="errorMessage" class="mt-1 text-sm text-red-500 flex items-center">
      <AlertTriangle class="mr-1 w-3 h-3" />{{ errorMessage }}
    </p>
...
import { ChevronDown, Search, AlertTriangle } from 'lucide-vue-next'
...
interface Emits {
  ...
  (e: 'update:fullNumber', value: string): void
}
